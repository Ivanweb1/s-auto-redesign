...
- `/?cases=portrait#portfolio` — альтернативный слайдер: активное фото 3:4 строго по центру, подпись под изображением и по два вертикальных превью с каждой стороны на широком экране.
